...
module.exports = class Wordle {
	...
	makeGuess(guess){
		// 1. .success = false, .error = "guess must be 5 alphabetic characters"
		// 2. .success = false, .error = "guess must be a word"
		// 3. .success = false, .error = "no guesses allowed for this game"
		// 4. .success = false, .error = "no more guesses allowed for this game"
		// 5. .success = true, .state = ?, .guess = ?, .score = ?
